...
<div id="ana">
  ...
  <div id="icyazi"> 
   <div style="width:850px;"><div id="habericerikyazi" style="color:#990000; font-family:Arial, Helvetica, sans-serif; font-weight:bold;width:80px;">Haber Tarihi</div>
    <div id="habericerikyazi" style="width:650px; float:left;">Başlık</div></div>
   	<?
	$haberid=$_GET['id'];
	$sql="select * from haberler where id=$haberid "; 
	$habersql=mysql_query($sql);
	while($haber=mysql_fetch_array($habersql))
	{
	?>
       <div style="width:850px;">
	   <div id="habericerikyazi" style="color:#990000; font-family:Arial, Helvetica, sans-serif; font-weight:bold;width:80px;"><?=$haber["tarih"];?></div>
    <div id="habericerikyazi" style="width:650px; float:left;"><?=$haber["baslik"];?> </div>
	<div id="habericerikyazi" style="width:650px;"><br>İçerik : <?=$haber["icerik"]; ?></div>
	
	</div><div style="clear:both;"></div>
    <?}?> 
	<br><br><center><a href="haberler.php"><img src="images/tumhaberler.png" width="81" height="11" /></a></center>
