...
<div id="ana">
  ...
  <div id="icyazi"> 
	...
	<tbody>
	<? include("baglan.php"); 
	$ref="select * from referanslar where aktif=1"; 
	$referans=mysql_query($ref);
	while($referanslar=mysql_fetch_array($referans))
	{
	?>
		<tr>
			<td style="text-align: center; vertical-align: middle; height: 50px;"><img alt="<?=$referanslar["adi"];?>" src="images/<?=$referanslar["imgurl"];?>" style="width: 173px; height: 48px;"></td>
			<td>
			<p><strong>&nbsp;<?=$referanslar["adi"];?>&nbsp;&nbsp;</strong></p>

			<div id="referanslar">&nbsp;<?=$referanslar["aciklama"];?></div>
			</td>
