...
<div id="ana">
  ...
  <div id="icyazi"> 
   <div style="width:850px;"><div id="habericerikyazi" style="color:#990000; font-family:Arial, Helvetica, sans-serif; font-weight:bold;width:80px;">Haber Tarihi</div>
	...
	{
	?>
       <div style="width:850px;"><div id="habericerikyazi" style="color:#990000; font-family:Arial, Helvetica, sans-serif; font-weight:bold;width:80px;"><?=$haber["tarih"];?></div>
    <div id="habericerikyazi" style="width:650px; float:left;"><a href="haberdetay.php?id=<?=$haber["id"];?>"><?=$haber["baslik"];?></a></div></div>
    <?}?>
